...
static PyMethodDef module_methods[] = {
    ...
    {"sub", sub_wrapper, METH_VARARGS,
     "Calculate the difference of two digits."},
    {"mul", mul_wrapper, METH_VARARGS,
     "Calculate the multiplication of two digits."},
    {"diV", div_wrapper, METH_VARARGS, "Calculate the divison of two digits."},
    {NULL, NULL, 0, NULL}};

static struct PyModuleDef calculator_module = {
    PyModuleDef_HEAD_INIT, "calculator",
    "A simple module to calculate simple number operations.", -1,
    module_methods};
