...
class Enemy:
    ...
    def __init__(
                    ...
                    enemy_agility: int = None, enemy_intelligence: int = None, enemy_strength: int = None, enemy_name: str = None
                ):
        """Constructor method.
        ...
        self.intelligence: int = enemy_intelligence
    ...
    async def print_parameters(self, message: Message):
        ...
        await message.answer(
                                ...
                                f"<b>Enemy intelligence</b>: <code>{self.intelligence}</code>\n" +
