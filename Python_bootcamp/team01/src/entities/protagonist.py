...
class Protagonist:
    ...
    def set_parameters(self):
        ...
        if len(self.inventory) > 0:
            if self.inventory[0] == "Chieftain's Gloves":
                self.armor += 2
            elif self.inventory[0] == "Cherubim Mantle":
                self.armor += 1
                self.agility += 1
                self.intelligence += 1
            elif self.inventory[0] == "Assasin's Uniform":
                self.armor += 1
                self.agility += 1
                self.strength += 1
                self.intelligence += 1
    ...
    async def fight(self, current_enemy: Enemy, message: Message):
        ...
        while enemy_health > 0:
            your_stats = self.strength + self.agility + self.intelligence + self.armor + random.randint(1, 6)
            enemy_stats = current_enemy.agility + current_enemy.intelligence + current_enemy.strength + current_enemy.armor + random.randint(1, 6)
