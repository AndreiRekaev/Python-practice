.. Calanthor - a land of eternal summer and magical forests documentation master file, created by
   sphinx-quickstart on Wed Oct  9 18:34:12 2024.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Calanthor - a land of eternal summer and magical forests documentation
======================================================================
...
**The Escape From Calanthor - a land of eternal summer and magical forests documentation!**
===================================================
...
- Установить пароль базе данных командой `ALTER ROLE postgres WITH LOGIN ENCRYPTED PASSWORD '1969';`.
...
*Welcome to the turn-based RPG game Escape from Calanthor - a land of eternal summer and magical forests.*
...
When you are at the last location, you can get out of the world with an e-key, which you must receive for completing the task. 
